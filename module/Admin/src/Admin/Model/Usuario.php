 ...
 *
 * @author Ana Paula <anapaulasif@unochapeco.edu.br>
 * @category Admin
 * @package Model
 */
class Usuario {
     ...
     *
     * @var \Admin\Model\Sexo
     */
    protected $sexo;

    /**
     * @ORM\ManyToMany(targetEntity="\Admin\Model\Interesse")
     ...
     * @param Sexo $sexo
     */
    public function setSexo(\Admin\Model\Sexo $sexo) {
        $this->sexo = $sexo;
    }
